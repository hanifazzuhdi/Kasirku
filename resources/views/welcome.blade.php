...
<head>
    ...
    <title>{{config('app.name')}} - Belanja lebih hemat dan mudah</title>
                ...
                <div class="col-12 hero-text-image">
                    <div class="row">
                        ...
                        <div class="col-lg-4 iphone-wrap">
                            <img src="{{asset('front/assets/img/phone_1.png')}}" alt="Image" class="phone-1"
                                data-aos="fade-right">
                            <img src="{{asset('front/assets/img/phone_2.png')}}" alt="Image" class="phone-2"
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5" data-aos="fade">
                    <div class="col-md-6 mb-5">
                        <img src="{{asset('front/assets/img/undraw_svg_1.svg')}}" alt="Image" class="img-fluid">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" data-aos="fade-left">
                        <img src="assets{{('front/assets/img/undraw_svg_2')}}.svg" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" data-aos="fade-right">
                        <img src="{{asset('front/assets/img/undraw_svg_3.svg')}}" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{asset('front/assets/img/person_1.jpg')}}" alt="Image"
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{asset('front/assets/img/person_2.jpg')}}" alt="Image"
                                                class="img-fluid rounded-circle mb-3">
                                            <span class="d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{asset('front/assets/img/person_3.jpg')}}" alt="Image"
                                                class="img-fluid rounded-circle mb-3">
                                            <span class="d-block">
